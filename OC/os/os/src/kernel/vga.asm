...
; Цвета: Золотой текст на темно-синем фоне (императорское знамя)
...
; Цветовая палитра "Имперский Стандарт"
; 0x1E = Золотой (желтый) текст на синем фоне (Царское знамя)
; 0x1F = Белый на синем (Особые сообщения)
; 0x0E = Золотой на черном (Предупреждения)
DEFAULT_COLOR_VALUE equ 0x1E
WARNING_COLOR_VALUE equ 0x1F
